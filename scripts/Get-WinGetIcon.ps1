...
function Resolve-IconBytesFromCandidates {
    ...
    foreach ($candidate in ($Candidates | Sort-Object Priority, Reason, Path)) {
        ...
        $genericIconSha256 = @(
            ...
            '2EE43237D196100210F1786E7B73B57CD140F6013C072C70DBDFFD9E9BC695F8', # Generic installer icon (766B)
            'A1326A5732A2411ABD2CB537599CBEEB22F477FFEFA0DFB01B30C8F94298AE4A', # Generic console/exe icon (766B)
            '9994932095864A4259B5C966ABE8097761BE39717F8CC349B9C4F43254388981', # Generic app icon (20110B)
            '7DFAA91B018C4C330F2AD3DE8C181E69C0A2A2E244A6C0F89A53D3BA0E301A1C', # Generic app icon (20014B)
            '5037C877CB134C1CD303367CFCC2AFECB0517522FF8AD98544D4EB158DDC6BDA'  # Generic app icon (13902B)
        )
